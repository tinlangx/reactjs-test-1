// Import ảnh local từ Figma (đặt dưới src/assets/anime/)
import img1 from "../assets/anime/1.svg";
import img2 from "../assets/anime/2.svg";
import img3 from "../assets/anime/3.svg";
import img4 from "../assets/anime/4.svg";
import img5 from "../assets/anime/5.svg";
import img6 from "../assets/anime/6.svg";
import img7 from "../assets/anime/7.svg";

/**
 * Schema theo yêu cầu:
 * {
 *   "data": [
 *     { "id": "1", "movieName": "...", "description": "...", "image": <import>, "episode": "01" }
 *   ]
 * }
 */
const shows = {
